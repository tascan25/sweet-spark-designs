  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        >
          {/* Using a sample video - replace with your Indian sweets video */}
          <source src={motibg} type="video/mp4" />
          {/* For actual Indian sweets video, you could use:
              - Upload your own video file to your server
              - Use a video from your media library
              - Use YouTube embed (requires different implementation)
          */}
        ...
        <motion.div
          ...
          className="absolute top-20 left-20 w-16 h-16 bg-saffron-200 rounded-full blur-xl opacity-30"
        />
        <motion.div
          animate={{
            y: [0, 20, 0],
          ...
          className="absolute bottom-20 right-20 w-20 h-20 bg-rose-200 rounded-full blur-xl opacity-30"
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-poppins font-bold mb-6">
            <span className="text-gradient">Moti</span>{" "}
            <span className="text-gray-200">Sweets</span>
          </h1>
        ...
        >
          ...
          >
            <span className="text-lg mb-2 font-semibold drop-shadow-md">Scroll to discover</span>
            <ChevronDown className="w-6 h-6" />
          </motion.div>
        </motion.a>
      </div>
